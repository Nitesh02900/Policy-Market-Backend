	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception
	{
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests((authorize) ->
                        authorize.requestMatchers(HttpMethod.GET, "/insuranceapp/**").permitAll()
                                .requestMatchers(HttpMethod.POST, "/insuranceapp/**").permitAll()
                                .requestMatchers(HttpMethod.PUT, "/insuranceapp/**").permitAll()
                                .requestMatchers(HttpMethod.DELETE, "/insuranceapp/**").permitAll()
